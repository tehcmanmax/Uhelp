...
public class CacheFactoryRefugee implements ISendMessageFactory {
    ...
    public CacheFactoryRefugee(IBuildSendMessageService ibuildSendMessageService, Cache<User> userCache, RefugeeProfile refugeeProfile, InlineNoProfiles inlineNoProfiles, NewProfileClientNotifier newProfileClientNotifier, UserRepository userRepository) {
